...
export const en = {
  ...
  login: {
    ...
    restoreDesc: 'Choose a method to restore your wallet',
    restoreMnemonic: 'Mnemonic Seed',
    restoreMnemonicDesc: 'Enter 12 or 24 BIP39 seed words',
    restoreWif: 'Private Key (WIF)',
    restoreWifDesc: 'Import a WIF private key into the restored wallet',
    restoreMnemonicPlaceholder: 'Enter your seed words...',
    restoreWifPlaceholder: 'WIF private key (e.g. L1... or K1...)',
    restorePasswordLabel: 'New wallet password',
